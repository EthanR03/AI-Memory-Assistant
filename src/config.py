...
# Season-level player statistics, one file per season per season_type
# (~25 MB all told). Also not committed; see src/nfl/playerstats.py.
NFLVERSE_STATS = NFLVERSE_DIR / "stats"
